 ...
 * generated in the com.rafik.hrms package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetEmployeeRequest_QNAME = new QName("http://rafik.com/hrms", "GetEmployeeRequest");
    private final static QName _RemoveEmployeeRequest_QNAME = new QName("http://rafik.com/hrms", "RemoveEmployeeRequest");
    private final static QName _GetAllEmployeeResponse_QNAME = new QName("http://rafik.com/hrms", "GetAllEmployeeResponse");
    private final static QName _GetEmployeeResponse_QNAME = new QName("http://rafik.com/hrms", "GetEmployeeResponse");
    private final static QName _GetAllEmployeeRequest_QNAME = new QName("http://rafik.com/hrms", "GetAllEmployeeRequest");
    private final static QName _RemoveEmployeeResponse_QNAME = new QName("http://rafik.com/hrms", "RemoveEmployeeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.rafik.hrms
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rafik.com/hrms", name = "GetEmployeeRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rafik.com/hrms", name = "RemoveEmployeeRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rafik.com/hrms", name = "GetAllEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rafik.com/hrms", name = "GetEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rafik.com/hrms", name = "GetAllEmployeeRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rafik.com/hrms", name = "RemoveEmployeeResponse")
